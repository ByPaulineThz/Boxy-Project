    ...
    <div className="fixed z-10 inset-0 flex items-center justify-center bg-gray-600/75 ">
      ...
      >
        <div className="flex items-end mb-5">
          ...
          <button
            onClick={handleCopy}
            className="ml-auto mr-2 text-sm bg-black text-white hover:bg-blue-900 py-1 px-3 rounded"
          >
            Copy
          </button>
          <button
            onClick={closeModal}
            className=" text-sm bg-red-700 text-white hover:bg-red-900 py-1 px-3 rounded"
          >
            Close
          </button>
        </div>
